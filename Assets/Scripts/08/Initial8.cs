...
public class Initial8 : MonoBehaviour
{
    public GameObject
     ...
     cupbzooma, cupbzoomb, fpzooma, fpzoomb,
        ...
        batszoom, batsnumzoom, hummeropen,
         blockbg, box, showTime, cutin,
        blackback, last,last2, endingImage,buttons
        , edButton3,mirroerzoom2,itembg;
    ...
    public void ShowBlockBG_initial()
    {
        BlockBG.instance.ShowBlock();
    }
