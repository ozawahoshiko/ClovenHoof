...
public class Fader01 : MonoBehaviour
{
    public GameObject　fadepanel, stamp,hint,box, arrows;
    ...
    IEnumerator Color_FadeOut()
    {
        ...
        // 色を徐々に変えるループ
        for (float alpha = 0.0f; alpha <= 190.0f; alpha += alpha_interval)
        {
            // 待ち時間
            yield return new WaitForSeconds(wait_time);
        ...
        StageClear.instance.StageClearStamp();
    }
    //ヒント隠し
